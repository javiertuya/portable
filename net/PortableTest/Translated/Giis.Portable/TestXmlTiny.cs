...
namespace Giis.Portable
{
	public class TestXmlTiny
	{
		...
		public virtual void TestElementFindChildAndGetContent()
		{
			...
			NUnit.Framework.Legacy.ClassicAssert.AreEqual(string.Empty, n1.InnerXml());
			NUnit.Framework.Legacy.ClassicAssert.AreEqual(string.Empty, n1.InnerText());
			// with only text
		...
		public virtual void TestElementFindChildNestedAndGetContent()
		{
			...
			NUnit.Framework.Legacy.ClassicAssert.AreEqual(Xml2.Replace("</elem2>", string.Empty).Replace("<elem2>", string.Empty), n.InnerXml());
		...
		public virtual void TestElementFindChildrenByName()
		{
			...
			NUnit.Framework.Legacy.ClassicAssert.AreEqual(0, n21[0].GetChildren("text1").Count);
		...
		public virtual void TestElementAttributesRead()
		{
			...
			NUnit.Framework.Legacy.ClassicAssert.AreEqual(string.Empty, n1.GetAttribute("doesnotexist"));
			// default is empty
			NUnit.Framework.Legacy.ClassicAssert.AreEqual("3", n1.GetAttribute("aaa"));
			NUnit.Framework.Legacy.ClassicAssert.AreEqual(" aaa=\"3\" bbb=\"text1\"", n1.GetAttributesString());
		}
		...
		public virtual void TestElementAttributesAsInt()
		{
			...
			NUnit.Framework.Legacy.ClassicAssert.AreEqual(0, n1.GetIntAttribute("notexistsint"));
			// default is 0
		...
		public virtual void TestElementAttributesAsElement()
		{
			...
			NUnit.Framework.Legacy.ClassicAssert.AreEqual("text2", n1.GetElementAtribute("bbb"));
			// first if there are more than one element
			NUnit.Framework.Legacy.ClassicAssert.AreEqual(string.Empty, n1.GetElementAtribute("doesnotexist"));
		}
		...
		public virtual void TestTextValuesAndChanges()
		{
			...
			NUnit.Framework.Legacy.ClassicAssert.AreEqual(string.Empty, n2.InnerText());
		...
		public virtual void TestTextAttributes()
		{
			...
			NUnit.Framework.Legacy.ClassicAssert.AreEqual(string.Empty, n.GetAttribute("none"));
		}
		...
		public virtual void TestEncodingFunctions()
		{
			...
			// supports nulls
			NUnit.Framework.Legacy.ClassicAssert.AreEqual(string.Empty, XNode.EncodeText(null));
			NUnit.Framework.Legacy.ClassicAssert.AreEqual(string.Empty, XNode.EncodeAttribute(null));
			NUnit.Framework.Legacy.ClassicAssert.AreEqual(string.Empty, XNode.DecodeText(null));
			NUnit.Framework.Legacy.ClassicAssert.AreEqual(string.Empty, XNode.DecodeAttribute(null));
		}
