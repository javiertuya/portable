...
namespace Giis.Portable
{
	public class TestJavaCs
	{
		...
		public virtual void TestSubstringOnlyBegin()
		{
			...
			NUnit.Framework.Legacy.ClassicAssert.AreEqual(string.Empty, JavaCs.Substring("ab", 2));
			try
			{
		...
		{
			NUnit.Framework.Legacy.ClassicAssert.AreEqual(string.Empty, JavaCs.Substring("abc", 1, 1));
		...
		public virtual void TestSplit()
		{
			...
			NUnit.Framework.Legacy.ClassicAssert.AreEqual("[]", JavaCs.DeepToString(JavaCs.SplitByChar(string.Empty, ',')));
		}
